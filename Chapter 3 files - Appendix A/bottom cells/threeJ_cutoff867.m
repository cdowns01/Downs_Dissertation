...
xout = xmax*decimation;  %Most recent value:1060
x_wave = xout+min1
yout = ymax*decimation;  %Most recent value:1314
y_wave = yout+min2
zout = zmax*decimation; %Most recent value:1800
z_wave = zout+min3

max_efficiency  %Most recent value:14.47%
