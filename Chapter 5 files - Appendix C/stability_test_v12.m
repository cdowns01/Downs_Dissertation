...
filepath=strcat('stability test v12/rand',num2str(randLow),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
for k = 1:numIntervals-2
	...
	%%phi_righ*phi_right
	matrix3(2*k,2*k) = matrix3(2*k,2*k) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f1((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);
    
	%% phi_right*phi_left
	matrix3(2*k,2*(k+1)) = matrix3(2*k,2*(k+1)) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f1((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);

       
	%% phi_left*phi_right
	matrix3(2*(k+1),2*(k)) = matrix3(2*(k+1),2*(k)) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f2((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);

	%% phi_left*phi_left
	matrix3(2*(k+1),2*(k+1)) = matrix3(2*(k+1),2*(k+1)) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f2((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError); 

    
    
	%% phi_right*psi_right
	matrix3(2*k,2*k+1) = matrix3(2*k,2*k+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f1((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);%

	%% phi_right*psi_left
	matrix3(2*k,2*(k+1)+1) = matrix3(2*k,2*(k+1)+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f1((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);

    
    
	%% phi_left*psi_right
	matrix3(2*(k+1),2*k+1) = matrix3(2*(k+1),2*k+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f2((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);

	%% phi_left*psi_left
	matrix3(2*(k+1),2*(k+1)+1) = matrix3(2*(k+1),2*(k+1)+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f2((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);%

    
    
    %psi_right*phi_right
    matrix3(2*k+1,2*k) = matrix3(2*k+1,2*k) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f3((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);%
    
    %psi_right*phi_left
    matrix3(2*k+1,2*(k+1))=matrix3(2*k+1,2*(k+1)) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f3((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);
    
    
    
    %psi_left*phi_right
    matrix3(2*(k+1)+1,2*k)=matrix3(2*(k+1)+1,2*k) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f4((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);
    
    %psi_left*psi_left
    matrix3(2*(k+1)+1,2*(k+1))=matrix3(2*(k+1)+1,2*(k+1)) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f4((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);  %
    
    
    
	%% psi_right*psi_right
	matrix3(2*k+1,2*k+1) = matrix3(2*k+1,2*k+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f3((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);

	%% psi_right*psi_left
	matrix3(2*k+1,2*(k+1)+1) = matrix3(2*k+1,2*(k+1)+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f3((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);

    
    
	%% psi_left*psi_right
	matrix3(2*(k+1)+1,2*k+1) = matrix3(2*(k+1)+1,2*k+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f4((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);

	%% psi_left*psi_right
	matrix3(2*(k+1)+1,2*(k+1)+1) = matrix3(2*(k+1)+1,2*(k+1)+1) + integral(@(x) (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f4((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),'AbsTol',AbsError,'RelTol',RelError);
end
...
%Handle 1st interval 'half case'
matrix3(1,1) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f1((x-node(1))) + alphap*f3((x-node(1)))).*(f1((x-node(1))) + alphap*f3((x-node(1)))),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
matrix3(1,2) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f1((x-node(1))) + alphap*f3((x-node(1)))).*f2((x-node(1))),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
matrix3(1,3) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f1((x-node(1))) + alphap*f3((x-node(1)))).*f4((x-node(1))),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
matrix3(2,1) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f1((x-node(1))) + alphap*f3((x-node(1)))).*f2((x-node(1))),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
matrix3(3,1) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f1((x-node(1))) + alphap*f3((x-node(1)))).*f4((x-node(1))),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);

 matrix3(2,2) = matrix3(2,2) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f2(x).*f2(x),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
 matrix3(2,3) = matrix3(2,3) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f2(x).*f4(x),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
 matrix3(3,2) = matrix3(3,2) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f2(x).*f4(x),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
 matrix3(3,3) = matrix3(3,3) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f4(x).*f4(x),node(1),node(1)+dx,'AbsTol',AbsError,'RelTol',RelError);
...
%Handle last interval 'half case'
matrix3(last,last) =   integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f2((x-node(end)+dx)) + betap*f4((x-node(end)+dx))).*(f2((x-node(end)+dx)) + betap*f4((x-node(end)+dx))),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
matrix3(last,last-2) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f2((x-node(end)+dx)) + betap*f4((x-node(end)+dx))).*f1((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
matrix3(last,last-1) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f2((x-node(end)+dx)) + betap*f4((x-node(end)+dx))).*f3((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
matrix3(last-2,last) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f2((x-node(end)+dx)) + betap*f4((x-node(end)+dx))).*f1((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
matrix3(last-1,last) = integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*(f2((x-node(end)+dx)) + betap*f4((x-node(end)+dx))).*f3((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);

matrix3(last-2,last-2) = matrix3(last-2,last-2) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f1((x-node(end)+dx)).*f1((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
matrix3(last-2,last-1) = matrix3(last-2,last-1) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f1((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
matrix3(last-1,last-2) = matrix3(last-1,last-2) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f1((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
matrix3(last-1,last-1) = matrix3(last-1,last-1) + integral(@(x)  (ksi.*T.*mup./q.*(nBlock(x))-1/taup).*f3((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);   
...
fig4 = figure;
plot(indexn,Cpjs,indexn,pGuess(indexn));title('p(x) calculated');
saveas(fig4,strcat(filepath,'/p_calculated_iteration',num2str(iterationCount),'.jpg'))

fig6 = figure;
plot(indexn,Dpjs,indexn,pprime(indexn)),title('pprime calculated');
