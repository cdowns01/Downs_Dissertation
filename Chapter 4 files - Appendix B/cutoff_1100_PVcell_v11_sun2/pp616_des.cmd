...
File {
	Grid = "n610_msh.tdr"
	Plot    = "n616_des.tdr"	*Commented out to limit memory usage on system.  Add back in for individual experiments, not long optimization simulations.
 	Current = "n616_des.plt"
	Output  = "n616_des.log"
	Parameter = "pp616_des.par"
	IlluminationSpectrum = "n612_am15d.txt"
      }
...
Solve   {
	 ...
	 * Plot (FilePrefix = "n616_sc")
    	
    	*CurrentPlot()
     	*System("rm -f n616_banddgm_des.tdr")
