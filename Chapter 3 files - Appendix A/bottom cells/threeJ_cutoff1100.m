...
xout = xmax*decimation;  %Most recent value:1312 
x_wave = xout+min1
yout = ymax*decimation;  %Most recent value:1698 
y_wave = yout+min2
zout = zmax*decimation; %Most recent value:2450
z_wave = zout+min3

max_efficiency  %Most recent value:7.05%
