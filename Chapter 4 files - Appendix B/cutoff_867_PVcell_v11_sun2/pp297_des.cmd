...
File {
	Grid = "n291_msh.tdr"
	Plot    = "n297_des.tdr"	*Commented out to limit memory usage on system.  Add back in for individual experiments, not long optimization simulations.
 	Current = "n297_des.plt"
	Output  = "n297_des.log"
	Parameter = "pp297_des.par"
	IlluminationSpectrum = "n293_am15d.txt"
      }
...
Solve   {
 Coupled (Iterations=20) {Poisson}
	 ...
	 * Plot (FilePrefix = "n297_sc")
    	
    	*CurrentPlot()
     	*System("rm -f n297_banddgm_des.tdr")
