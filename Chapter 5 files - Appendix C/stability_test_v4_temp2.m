...
for k = 3:numIntervals-1
    ...
    %Phi(k) Phi(k-1)    
    matrix2(2*k-4,2*k-2) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);

    %Phi(k) Psi(k-1)
    matrix2(2*k-3,2*k-2) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
   
    %Phi(k) Phi(k)
    matrix2(2*k-2,2*k-2) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x),   (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k)
    matrix2(2*k-1,2*k-2) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x),   (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Phi(k+1)
    matrix2(2*k,2*k-2) =   quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k+1)
    matrix2(2*k+1,2*k-2) = quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);   
     

    %%Calculate for interval's Psi basis function
    %Corresponds to column Dk
    %%Psi(k) Phi(k-1)
    matrix2(2*k-4,2*k-1) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);

    %Psi(k) Psi(k-1)
    matrix2(2*k-3,2*k-1) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
   
    %Psi(k) Phi(k)
    matrix2(2*k-2,2*k-1) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x),    (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k)
    matrix2(2*k-1,2*k-1) = quad(@(x) pprime_dist{k}(x)./p_dist{k}(x),    (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Psi(k) Phi(k+1)
    matrix2(2*k,2*k-1) =   quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k+1)
    matrix2(2*k+1,2*k-1) = quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
end

%Handle 1st interval 'half case'
%Phis 
matrix2(1,1) = quad(@(x) pprime_dist{2}(x)./p_dist{2}(x),startPoint, intervalLength+startPoint,Error)+alphan*quad(@(x) pprime_dist{2}(x)./p_dist{2}(x),startPoint, intervalLength+startPoint,Error);
matrix2(2,1) = quad(@(x) pprime_dist{2}(x)./p_dist{2}(x),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) pprime_dist{2}(x)./p_dist{2}(x),startPoint, intervalLength+startPoint,Error);
matrix2(3,1) = quad(@(x) pprime_dist{2}(x)./p_dist{2}(x),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) pprime_dist{2}(x)./p_dist{2}(x),startPoint, intervalLength+startPoint,Error);


%Handle last interval 'half case'
%Phis 
matrix2(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(@(x) pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan*quad(@(x) pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix2(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(@(x) pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan*quad(@(x) pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix2(2*(numIntervals),2*(numIntervals+1)-2)=   quad(@(x) pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan*quad(@(x) pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
...
for k = 3:numIntervals-1
    ...
    %%Corresponds to column Ck
    %Phi(k) Phi(k-1)
    matrix3(2*k-4,2*k-2) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);

    %Phi(k) Psi(k-1)
    matrix3(2*k-3,2*k-2) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
   
    %Phi(k) Phi(k)
    matrix3(2*k-2,2*k-2) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),   (k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k)
    matrix3(2*k-1,2*k-2) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),   (k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Phi(k+1)
    matrix3(2*k,2*k-2) =   quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k+1)
    matrix3(2*k+1,2*k-2) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);   
     

    %%Calculate for interval's Psi basis function
    %Corresponds to column Dk
    %%Psi(k) Phi(k-1)
    matrix3(2*k-4,2*k-1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);

    %Psi(k) Psi(k-1)
    matrix3(2*k-3,2*k-1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
   
    %Psi(k) Phi(k)
    matrix3(2*k-2,2*k-1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),    (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k)
    matrix3(2*k-1,2*k-1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),    (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint,(k)*intervalLength+startPoint,Error);
    
    %Psi(k) Phi(k+1)
    matrix3(2*k,2*k-1) =   quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k+1)
    matrix3(2*k+1,2*k-1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
end

%Handle 1st interval 'half case'
%Phis
matrix3(1,1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{2}(x)./p_dist{2}(x) - (pprime_dist{2}(x)./p_dist{2}(x)).^2)-1/taun),startPoint, intervalLength+startPoint,Error)+alphan*quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{2}(x)./p_dist{2}(x) - (pprime_dist{2}(x)./p_dist{2}(x)).^2)-1/taun),startPoint, intervalLength+startPoint,Error);
matrix3(2,1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{2}(x)./p_dist{2}(x) - (pprime_dist{2}(x)./p_dist{2}(x)).^2)-1/taun),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{2}(x)./p_dist{2}(x) - (pprime_dist{2}(x)./p_dist{2}(x)).^2)-1/taun),startPoint, intervalLength+startPoint,Error);
matrix3(3,1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{2}(x)./p_dist{2}(x) - (pprime_dist{2}(x)./p_dist{2}(x)).^2)-1/taun),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{2}(x)./p_dist{2}(x) - (pprime_dist{2}(x)./p_dist{2}(x)).^2)-1/taun),startPoint, intervalLength+startPoint,Error);

%Handle last interval 'half case'
%Phis
matrix3(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x) - (pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x)).^2)-1/taun),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan.*quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x) - (pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x)).^2)-1/taun).*psi_left{numIntervals+1}(x).*phi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix3(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x) - (pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x)).^2)-1/taun),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan.*quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x) - (pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x)).^2)-1/taun).*psi_left{numIntervals+1}(x).*psi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix3(2*(numIntervals),2*(numIntervals+1)-2)=   quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x) - (pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x)).^2)-1/taun),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betan.*quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x) - (pprime_dist{numIntervals+1}(x)./p_dist{numIntervals+1}(x)).^2)-1/taun).*psi_left{numIntervals+1}(x).*(phi_left{numIntervals+1}(x)+betan.*psi_left{numIntervals+1}(x)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
...
%Psi(k) Phi(k)
matrix3(2*k-2,2*k-1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),    (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*psi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
   
%Psi(k) Psi(k)
matrix3(2*k-1,2*k-1) = quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k}(x)./p_dist{k}(x) - (pprime_dist{k}(x)./p_dist{k}(x)).^2)-1/taun),    (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x) - (pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*psi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
