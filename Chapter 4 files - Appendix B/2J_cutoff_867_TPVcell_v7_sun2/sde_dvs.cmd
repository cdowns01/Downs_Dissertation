...
(define WIDTHS (list  @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@))
(define HEIGHTS (list .04 .3 .7 .05 @tunnel_depth@ @tunnel_depth@ .1 .3 @depth@ .5 .5))
