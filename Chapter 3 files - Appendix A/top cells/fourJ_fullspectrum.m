...
xout = xmax*decimation;  %Most recent value:615;
x_wave = xout+min1
yout = ymax*decimation;  %Most recent value:820;
y_wave = yout+min2
zout = zmax*decimation; %Most recent value:1090;
z_wave = zout+min3
wout = wmax*decimation; %Most recent value:1645;
w_wave = wout+min4

max_efficiency  %Most recent value:50.95%
