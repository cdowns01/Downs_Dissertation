...
File {
	Grid = "n610_msh.tdr"
	Plot    = "n634_des.tdr"	*Commented out to limit memory usage on system.  Add back in for individual experiments, not long optimization simulations.
 	Current = "n634_des.plt"
	Output  = "n634_des.log"
	Parameter = "pp634_des.par"
	IlluminationSpectrum = "n630_am15d.txt"
      }
...
Solve   {
	 ...
	 * Plot (FilePrefix = "n634_sc")
    	
    	*CurrentPlot()
     	*System("rm -f n634_banddgm_des.tdr")
