...
%    
    %Phi(k) Phi(k) 
    %+quad(@(x) d2_phi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix1(2*k-2,2*k-2) = quad(@(x) d2_phi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k)
    %+quad(@(x) d2_phi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix1(2*k-1,2*k-2) = quad(@(x) d2_phi_left{k}(x).*psi_left{k}(x),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error);
%     
%     %Phi(k) Phi(k+1)
%     matrix1(2*k,2*k-2) =   quad(@(x) d2_phi_right{k}(x).*phi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
...
%    
    %Psi(k) Phi(k)
    %%%%+quad(@(x) d2_psi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix1(2*k-2,2*k-1) = quad(@(x) d2_psi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k)
    %%%%%+quad(@(x) d2_psi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint,(k)*intervalLength+startPoint,Error);
    matrix1(2*k-1,2*k-1) = quad(@(x) d2_psi_left{k}(x).*psi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
...
%Phi(k) Phi(k)
%quad(@(x) d2_phi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+
matrix1(2*k-2,2*k-2) = quad(@(x) d2_phi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
%Phi(k) Psi(k)
%quad(@(x) d2_phi_left{k}(x).*psi_left{k}(x),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+
matrix1(2*k-1,2*k-2) = quad(@(x) d2_phi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
...
for k = 3:numIntervals-1
    ...
    %Phi(k) Phi(k-1)    
%     matrix2(2*k-4,2*k-2) = quad(@(x) d_phi_left{k}(x).*phi_right{k-1}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
% 
%     %Phi(k) Psi(k-1)
%     matrix2(2*k-3,2*k-2) = quad(@(x) d_phi_left{k}(x).*psi_right{k-1}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%    
    %Phi(k) Phi(k)
    %+quad(@(x) d_phi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix2(2*k-2,2*k-2) = quad(@(x) d_phi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k)
    %+ quad(@(x) d_phi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix2(2*k-1,2*k-2) =quad(@(x) d_phi_left{k}(x).*psi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
    
%     %Phi(k) Phi(k+1)
%     matrix2(2*k,2*k-2) =   quad(@(x) d_phi_right{k}(x).*phi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Phi(k) Psi(k+1)
%     matrix2(2*k+1,2*k-2) = quad(@(x) d_phi_right{k}(x).*psi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);   
%      
% 
%     %%Calculate for interval's Psi basis function
%     %Corresponds to column Dk
%     %%Psi(k) Phi(k-1)
%     matrix2(2*k-4,2*k-1) = quad(@(x) d_psi_left{k}(x).*phi_right{k-1}(x), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
% 
%     %Psi(k) Psi(k-1)
%     matrix2(2*k-3,2*k-1) = quad(@(x) d_psi_left{k}(x).*psi_right{k-1}(x), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%    
    %Psi(k) Phi(k)
    %+quad(@(x) d_psi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix2(2*k-2,2*k-1) = quad(@(x) d_psi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k)
    %+quad(@(x) d_psi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix2(2*k-1,2*k-1) = quad(@(x) d_psi_left{k}(x).*psi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
    
%     %Psi(k) Phi(k+1)
%     matrix2(2*k,2*k-1) =   quad(@(x) d_psi_right{k}(x).*phi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Psi(k) Psi(k+1)
%     matrix2(2*k+1,2*k-1) = quad(@(x) d_psi_right{k}(x).*psi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
end

%Handle 1st interval 'half case'
%Phis 
matrix2(1,1) = quad(@(x) d_phi_right{1}(x).*(phi_right{1}(x)+alphan.*psi_right{1}(x)),startPoint, intervalLength+startPoint,Error)+alphan*quad(@(x) d_psi_right{1}(x).*(phi_right{1}(x)+alphan.*psi_right{1}(x)),startPoint, intervalLength+startPoint,Error);
matrix2(2,1) = quad(@(x) d_phi_right{1}(x).*phi_left{2}(x),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) d_psi_right{1}(x).*phi_left{2}(x),startPoint, intervalLength+startPoint,Error);
matrix2(3,1) = quad(@(x) d_phi_right{1}(x).*psi_left{2}(x),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) d_psi_right{1}(x).*psi_left{2}(x),startPoint, intervalLength+startPoint,Error);


%Handle last interval 'half case'
%Phis 
matrix2(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(@(x) d_phi_left{numIntervals+1}(x).*phi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan*quad(@(x) d_psi_left{numIntervals+1}(x).*phi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix2(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(@(x) d_phi_left{numIntervals+1}(x).*psi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan*quad(@(x) d_psi_left{numIntervals+1}(x).*psi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix2(2*(numIntervals),2*(numIntervals+1)-2)=   quad(@(x) d_phi_left{numIntervals+1}(x).*(phi_left{numIntervals+1}(x)+betan.*psi_left{numIntervals+1}(x)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betan*quad(@(x) d_psi_left{numIntervals+1}(x).*(phi_left{numIntervals+1}(x)+betan.*psi_left{numIntervals+1}(x)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
...
k=2;
%Phi(k) Phi(k-1)
% matrix2(2*k-3,2*k-2) = quad(@(x) d_phi_left{k}(x).*(phi_right{1}(x)+alphan.*psi_right{1}(x)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
...
% %Corresponds to column Dk
% %%Psi(k) Phi(k-1)
% matrix2(2*k-3,2*k-1) = quad(@(x) d_psi_left{k}(x).*(phi_right{1}(x)+alphan.*psi_right{1}(x)), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%   
%Psi(k) Phi(k)
%+quad(@(x) d_psi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
matrix2(2*k-2,2*k-1) = quad(@(x) d_psi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
...
% %Phi(k) Phi(k+1)
% matrix2(2*k,2*k-2) =   quad(@(x) d_phi_right{k}(x).*(phi_left{k+1}(x)+betan.*psi_left{k+1}(x)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
% 
% %%Calculate for interval's Psi basis function
% %Corresponds to column Dk
...
% %Psi(k) Phi(k+1)
% matrix2(2*k,2*k-1) =   quad(@(x) d_psi_right{k}(x).*(phi_left{k+1}(x)+betan.*psi_left{k+1}(x)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
...
for k = 3:numIntervals-1
    ...
    %%Corresponds to column Ck
    %Phi(k) Phi(k-1)
%     matrix3(2*k-4,2*k-2) = quad(@(x) phi_left{k}(x).*phi_right{k-1}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
% 
%     %Phi(k) Psi(k-1)
%     matrix3(2*k-3,2*k-2) = quad(@(x) phi_left{k}(x).*psi_right{k-1}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%    
    %Phi(k) Phi(k)
    %+quad(@(x) phi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix3(2*k-2,2*k-2) = quad(@(x) phi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k)
    %+quad(@(x) phi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix3(2*k-1,2*k-2) = quad(@(x) phi_left{k}(x).*psi_left{k}(x),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error);
    
    %Phi(k) Phi(k+1)
%     matrix3(2*k,2*k-2) =   quad(@(x) phi_right{k}(x).*phi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Phi(k) Psi(k+1)
%     matrix3(2*k+1,2*k-2) = quad(@(x) phi_right{k}(x).*psi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);   
%      
% 
%     %%Calculate for interval's Psi basis function
%     %Corresponds to column Dk
%     %%Psi(k) Phi(k-1)
%     matrix3(2*k-4,2*k-1) = quad(@(x) psi_left{k}(x).*phi_right{k-1}(x), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
% 
%     %Psi(k) Psi(k-1)
%     matrix3(2*k-3,2*k-1) = quad(@(x) psi_left{k}(x).*psi_right{k-1}(x), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%    
    %Psi(k) Phi(k)
    %+quad(@(x) psi_right{k}(x).*phi_right{k}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    matrix3(2*k-2,2*k-1) = quad(@(x) psi_left{k}(x).*phi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k)
    %+quad(@(x) psi_right{k}(x).*psi_right{k}(x),(k-1)*intervalLength+startPoint,(k)*intervalLength+startPoint,Error);
    matrix3(2*k-1,2*k-1) = quad(@(x) psi_left{k}(x).*psi_left{k}(x),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
    
%     %Psi(k) Phi(k+1)
%     matrix3(2*k,2*k-1) =   quad(@(x) psi_right{k}(x).*phi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Psi(k) Psi(k+1)
%     matrix3(2*k+1,2*k-1) = quad(@(x) psi_right{k}(x).*psi_left{k+1}(x),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
end

%Handle 1st interval 'half case'
%Phis
matrix3(1,1) = quad(@(x) phi_right{1}(x).*(phi_right{1}(x)+alphan.*psi_right{1}(x)),startPoint, intervalLength+startPoint,Error)+alphan*quad(@(x) psi_right{1}(x).*(phi_right{1}(x)+alphan.*psi_right{1}(x)),startPoint, intervalLength+startPoint,Error);
matrix3(2,1) = quad(@(x) phi_right{1}(x).*phi_left{2}(x),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) psi_right{1}(x).*phi_left{2}(x),startPoint, intervalLength+startPoint,Error);
matrix3(3,1) = quad(@(x) phi_right{1}(x).*psi_left{2}(x),startPoint, intervalLength+startPoint,Error)                           +alphan*quad(@(x) psi_right{1}(x).*psi_left{2}(x),startPoint, intervalLength+startPoint,Error);

%Handle last interval 'half case'
%Phis
matrix3(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(@(x) phi_left{numIntervals+1}(x).*phi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan.*quad(@(x) psi_left{numIntervals+1}(x).*phi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix3(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(@(x) phi_left{numIntervals+1}(x).*psi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)                                      +betan.*quad(@(x) psi_left{numIntervals+1}(x).*psi_right{numIntervals}(x),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix3(2*(numIntervals),2*(numIntervals+1)-2)=   quad(@(x) phi_left{numIntervals+1}(x).*(phi_left{numIntervals+1}(x)+betan.*psi_left{numIntervals+1}(x)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betan.*quad(@(x) psi_left{numIntervals+1}(x).*(phi_left{numIntervals+1}(x)+betan.*psi_left{numIntervals+1}(x)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
...
k=2;
% %Phi(k) Phi(k-1)
% matrix3(2*k-3,2*k-2) = quad(@(x) phi_left{k}(x).*(phi_right{k-1}(x)+alphan.*psi_right{k-1}(x)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
...
%Corresponds to column Dk
% %%Psi(k) Phi(k-1)
% matrix3(2*k-3,2*k-1) = quad(@(x) psi_left{k}(x).*(phi_right{k-1}(x)+alphan.*psi_right{k-1}(x)), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
...
% %Phi(k) Phi(k+1)
% matrix3(2*k,2*k-2) =   quad(@(x) phi_right{k}(x).*(phi_left{k+1}(x)+betan.*psi_left{k+1}(x)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
% 
% %%Calculate for interval's Psi basis function
% %Corresponds to column Dk
...
% %Psi(k) Phi(k+1)
% matrix3(2*k,2*k-1) =   quad(@(x) psi_right{k}(x).*(phi_left{k+1}(x)+betan.*psi_left{k+1}(x)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
