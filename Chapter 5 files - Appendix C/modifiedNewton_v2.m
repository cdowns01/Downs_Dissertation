...
%Modified Newton, noisy input, no Jacobian
...
filepath=strcat('modifiedNewton v2/rand',num2str(rand),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
[x,fval,exitflag,output]= fsolve(@(x)callFunction(x),Coeffs,options)
count=2
