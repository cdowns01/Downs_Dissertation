...
efficiencies = zeros(max1/decimation-min1/decimation,max2/decimation-min2/decimation,max3/decimation-min3/decimation,max4/decimation-min4/decimation)/C;
...
xout = xmax*decimation;  %Most recent value:535
x_wave = xout+min1
yout = ymax*decimation;  %Most recent value:660
y_wave = yout+min2
zout = zmax*decimation; %Most recent value:785
z_wave = zout+min3
wout = wmax*decimation; %Most recent value:925
w_wave = wout+min4

max_efficiency  %Most recent value:50.12%
