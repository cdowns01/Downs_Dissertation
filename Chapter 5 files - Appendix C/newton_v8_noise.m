...
filepath=strcat('newton v8/rand',num2str(rand),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
fig4 = figure;
plot(indexn,Cnjs,'x',indexn,nGuess(indexn),indexn,nOrig(indexn));title('n(x) calculated'),legend('Cnjs','nGuess - error','nGuess - original');set(gca,'FontSize',14),xlabel('Depth (in cm)'),ylabel('Carrier concentration (in cm^-3)');
saveas(fig4,strcat(filepath,'/n_calculated_iteration',num2str(iterationCount),'.jpg'))

fig6 = figure;
plot(indexn,Dnjs,'x',indexn,nprime(indexn),indexn,nprimeOrig(indexn)),title('nprime calculated'),legend('Dnjs','nprime - error','nprime - original');set(gca,'FontSize',14),xlabel('Depth (in cm)'),ylabel('Carrier concentration (in cm^-3)');
...
fig4 = figure;
plot(indexn,Cpjs,'x',indexn,pGuess(indexn),indexn,pOrig(indexn));title('p(x) calculated'),legend('Cpjs','pGuess - error','pGuess - orignial');set(gca,'FontSize',14),xlabel('Depth (in cm)'),ylabel('Carrier concentration (in cm^-3)');
saveas(fig4,strcat(filepath,'/p_calculated_iteration',num2str(iterationCount),'.jpg'))

fig6 = figure;
plot(indexn,Dpjs,'x',indexn,pprime(indexn),indexn,pprimeOrig(indexn)),title('pprime calculated'),legend('Dpjs','pGuess - error','pGuess - orignial');set(gca,'FontSize',14),xlabel('Depth (in cm)'),ylabel('Carrier concentration (in cm^-3)');
