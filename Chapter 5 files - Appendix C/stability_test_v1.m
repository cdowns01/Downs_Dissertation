...
saveas(fig5,strcat(filepath,'/nGuess.jpg'))
...
saveas(fig2,strcat(filepath,'/pGuess_noisy.jpg'))
...
fig3=figure;
subplot(1,2,1),plot(Cpjs),title('pGuess (recomposition)');
subplot(1,2,2),plot(Dpjs),title('pprime (recomposition)');

saveas(fig3,strcat(filepath,'/pGuess_recomposition.jpg'))
...
saveas(fig4,strcat(filepath,'/nGuess_output.jpg'))
