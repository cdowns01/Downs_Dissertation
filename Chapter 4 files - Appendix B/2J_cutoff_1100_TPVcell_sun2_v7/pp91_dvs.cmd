...
(define WIDTHS (list 50.0 50.0  50.0 50.0 50.0 50.0 50.0 50.0 50.0 50.0 50.0 50.0))
(define HEIGHTS (list .04 .3 .3 .05 .03 .03 .1 .5 3 .5 .5))
...
(sdegeo:create-rectangle (position -25.0 0 0) (position -24.0 -.5 0) "Gold" "Gold_region_1")
(sdegeo:create-rectangle (position -24.0 0 0) (position 25.0 -.25 0) "TiOx" "TiOx_region_1")
(sdegeo:create-rectangle (position -24.0 -.25 0) (position 25.0 -.5 0) "MgF" "MgF_region_1")
...
(sdegeo:define-2d-contact (find-edge-id (position -24.9 -.5 0 )) "back")
