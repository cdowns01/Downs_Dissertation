...
(define WIDTHS (list @width@ @width@  @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@ @width@))
(define HEIGHTS (list .04 .3 @top_depth@ .05 @tunnel_depth@ @tunnel_depth@ .1 .5 3 .1 @tunnel_depth@ @tunnel_depth@ .1 .3 3 .5 .5))
