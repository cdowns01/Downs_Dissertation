...
filepath=strcat('newton v1/rand',num2str(randLow),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
% x_axis=0:dx/100:dx;
% subplot(221),plot(x_axis,f1primeprime(x_axis))
% subplot(222),plot(x_axis,f2primeprime(x_axis))
% subplot(223),plot(x_axis,f3primeprime(x_axis))
% subplot(224),plot(x_axis,f4primeprime(x_axis))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
% fig4 = figure;
% plot(indexn,Cnjs,'x',node,nGuess(node)),title('nGuess (recomposition)');
% saveas(fig4,strcat(filepath,'/nGuess_recomposition.jpg'))
% 
% fig4 = figure;
% plot(indexn,Dnjs,'x',node,nprime(node)),title('nprime (recomposition)');
% saveas(fig4,strcat(filepath,'/nprime_recomposition.jpg'))
% 
% fig5 = figure;
% plot(indexn,Cpjs,'x',node,pGuess(node)),title('pGuess (recomposition)');
% saveas(fig5,strcat(filepath,'/pGuess_recomposition.jpg'))
% 
% fig5 = figure;
% plot(indexn,Dpjs,'x',node,pprime(node)),title('pprime (recomposition)');
...
%RHS edge cases
%nGuess
rhs_matrix(last-1) = rhs_matrix(last)+ integral(@(x) (f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*Gopn(x),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
...
%     %Cp2 p'k/nk + 2*Cn3*(n'k)^2 pk/(nk)^2
%     pBlock = @(x) Cp2*(Cpjs(k).*f1prime(x-node(k)) + Cpjs(k+1).*f2prime(x-node(k)) + Dpjs(k).*f3prime(x-node(k)) + Dpjs(k+1).*f4prime(x-node(k)))./(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k)))+2.*Cp3.*(Cnjs(k).*f1prime(x-node(k)) + Cnjs(k+1).*f2prime(x-node(k)) + Dnjs(k).*f3prime(x-node(k)) + Dnjs(k+1).*f4prime(x-node(k))).*(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k)))./(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k))).^2;
%     k=k-1;
% 	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     %Block 1  - (Upper left 4x4)
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     nBlock = @(x) Cn2.*(Cnjs(k).*f1prime(x-node(k)) + Cnjs(k+1).*f2prime(x-node(k)) + Dnjs(k).*f3prime(x-node(k)) + Dnjs(k+1).*f4prime(x-node(k)))/(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k)))-2.*Cn3.*(Cpjs(k).*f1prime(x-node(k)) + Cpjs(k+1).*f2prime(x-node(k)) + Dpjs(k).*f3prime(x-node(k)) + Dpjs(k+1).*f4prime(x-node(k))).*(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k)))./(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k))).^2;
%     %Cp2*nk'/nk
...
%     %Cp3*nk''pk/nk^2-Cp2*nk' pk'/nk^2 - Cp3(nk')^2*pk/(nk)^3
%     pBlock = @(x) Cp3*(Cnjs(k).*f1primeprime(x-node(k)) + Cnjs(k+1).*f2primeprime(x-node(k)) + Dnjs(k).*f3primeprime(x-node(k)) + Dnjs(k+1).*f4primeprime(x-node(k))).*(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k)))./(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k))).^2 - Cp2*(Cnjs(k).*f1prime(x-node(k)) + Cnjs(k+1).*f2prime(x-node(k)) + Dnjs(k).*f3prime(x-node(k)) + Dnjs(k+1).*f4prime(x-node(k))).*(Cpjs(k).*f1prime(x-node(k)) + Cpjs(k+1).*f2prime(x-node(k)) + Dpjs(k).*f3prime(x-node(k)) + Dpjs(k+1).*f4prime(x-node(k)))./(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k))).^2 - Cp3*(Cnjs(k).*f1prime(x-node(k)) + Cnjs(k+1).*f2prime(x-node(k)) + Dnjs(k).*f3prime(x-node(k)) + Dnjs(k+1).*f4prime(x-node(k))).^2.*(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k)))./(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k))).^3;
%     k=k-1;
% 	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     %Block 1  - (Upper left 4x4)
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
% %matrixDelN(psi(p,r),xx)
% matrixDelN(last-3,last-4) = matrixDelN(last-3,last-6) + integral(@(x) pBlock(x).*f3(x-node(end)+dx).*f1(x-node(end)+dx),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
% matrixDelN(last-2,last-4) = matrixDelN(last-2,last-6) + integral(@(x) pBlock(x).*f3(x-node(end)+dx).*f3(x-node(end)+dx),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
%    
...
% end    
%     k=1;
%    nBlock = @(x) 2*Cn3.*(Cpjs(k).*f1prime(x-node(k)) + Cpjs(k+1).*f2prime(x-node(k)) + Dpjs(k).*f3prime(x-node(k)) + Dpjs(k+1).*f4prime(x-node(k))).^2.*(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k)))./(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k))).^3-Cn3.*(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k))).*(Cnjs(k).*f1(x-node(k)) + Cnjs(k+1).*f2(x-node(k)) + Dnjs(k).*f3(x-node(k)) + Dnjs(k+1).*f4(x-node(k)))./(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k))).^2-Cn2.*(Cpjs(k).*f1prime(x-node(k)) + Cpjs(k+1).*f2prime(x-node(k)) + Dpjs(k).*f3prime(x-node(k)) + Dpjs(k+1).*f4prime(x-node(k))).*(Cnjs(k).*f1prime(x-node(k)) + Cnjs(k+1).*f2prime(x-node(k)) + Dnjs(k).*f3prime(x-node(k)) + Dnjs(k+1).*f4prime(x-node(k)))./(Cpjs(k).*f1(x-node(k)) + Cpjs(k+1).*f2(x-node(k)) + Dpjs(k).*f3(x-node(k)) + Dpjs(k+1).*f4(x-node(k))).^2;
%    pBlock = @(x) Cp3*(Cpjs(k).*f1prime(x-node(k)) + Cpjs(k+1).*f2prime(x-node(k)) + Dpjs(k).*f3prime(x-node(k)) + Dpjs(k+1).*f4prime(x-node(k)))./(Cnjs(k).*f1prime(x-node(k)) + Cnjs(k+1).*f2prime(x-node(k)) + Dnjs(k).*f3prime(x-node(k)) + Dnjs(k+1).*f4prime(x-node(k)));
%     
% %Handle 1st interval 'half case'
% %Top left 2x2 block
...
Rn1(last-1) = Rn1(last)+ integral(@(x) (f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*nBlock(x),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
...
% 
% %last interval edge cases
% Rn2(last-1) = Rn2(last)+ integral(@(x) (f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*nBlock(x),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
...
%  
% %last interval edge cases
% Rn3(last-1) = Rn3(last)+ integral(@(x) (f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*nBlock(x),node(end)-dx,node(end),'AbsTol',AbsError,'RelTol',RelError);
...
RHSFinal = RHSOut-Rn1-Rp1;%-Rn2-Rn3-Rp1-Rp2-Rp3;
...
fig4 = figure;
plot(indexn,Cnjs,'x',node,nGuess(node)),title('nGuess (calculated)');
saveas(fig4,strcat(filepath,'/nGuess_recomposition.jpg'))

fig4 = figure;
plot(indexn,Dnjs,'x',node,nprime(node)),title('nprime (calculated)');
saveas(fig4,strcat(filepath,'/nprime_recomposition.jpg'))

fig5 = figure;
plot_together(Cnjs,Dnjs,totalLength,numIntervals);title('plot together (n)');
saveas(fig5,strcat(filepath,'/plot_together_n',num2str(iterationCount),'.jpg'))

fig5 = figure;
plot(indexn,Cpjs,'x',node,pGuess(node)),title('pGuess (calculated)');
saveas(fig5,strcat(filepath,'/pGuess_recomposition.jpg'))

fig5 = figure;
plot(indexn,Dpjs,'x',node,pprime(node)),title('pprime (calculated)');
saveas(fig5,strcat(filepath,'/pprime_recomposition.jpg'))

fig5 = figure;
plot_together(Cpjs,Dpjs,totalLength,numIntervals);title('plot together (p)');
