...
File {
	Grid = "n91_msh.tdr"
	Plot    = "n392_des.tdr"	*Commented out to limit memory usage on system.  Add back in for individual experiments, not long optimization simulations.
 	Current = "n392_des.plt"
	Output  = "n392_des.log"
	Parameter = "pp392_des.par"
	IlluminationSpectrum = "n136_am15d.txt"
      }
...
Solve   {
	 ...
	 * Plot (FilePrefix = "n392_sc")
    	
    	*CurrentPlot()
     	*System("rm -f n392_banddgm_des.tdr")
     	
     	Quasistationary ( 
   		 InitialStep=5e-2 MaxStep =1e-2 MinStep = 1e-3 
    		Goal{ voltage = .7 Name = "front" }
 	   ){ Coupled {Poisson Electron Hole  } } 
