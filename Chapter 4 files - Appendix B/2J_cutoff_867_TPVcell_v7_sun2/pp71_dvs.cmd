...
(define WIDTHS (list  50.0 50.0 50.0 50.0 50.0 50.0 50.0 50.0 50.0 50.0 50.0))
(define HEIGHTS (list .04 .3 .7 .05 .03 .03 .1 .3 2 .5 .5))
(define REGION_LABELS (list "_mid_window" "_region5" "_region6" "_mid_BSF" "_region7" "_region8" "_bot_window" "_region9" "_region10" "_bot_BSF" "region_gold"))
...
(define PROFILE_NAMES (list "mid_window" "n_InGaAs" "p_InGaAs" "mid_BSF" "p_tunnel2" "n_tunnel2" "bot_window" "n_Ge" "p_Ge" "bot_BSF" "gold"))

(define Y 0)
(define X 0)

(sdegeo:create-rectangle (position -25.0 0 0) (position -24.0 -0.607 0) "Gold" "Gold_region_1")
(sdegeo:create-rectangle (position -24.0 0 0) (position 25.0 -0.521 0) "TiOx" "TiOx_region_1")
(sdegeo:create-rectangle (position -24.0 0.521 0) (position 25.0 -0.607 0) "MgF" "MgF_region_1")
...
(sdegeo:define-2d-contact (find-edge-id (position -24.9 -0.607 0 )) "back")
