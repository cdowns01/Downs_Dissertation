...
filepath=strcat('modifiedNewton test/rand',num2str(rand),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
% 
% n1rand=-7.7678*10^10;
% n2rand=9.05233*10^11;
% n3rand=-1.47728*10^14;
% n4rand=1.58013*10^14;
...
% %Calcs done in Mathematica
% 
% p1rand=-2.66795*10^16;
% p2rand=-9.7429*10^11;
% p3rand=-2.73046*10^17;
% p4rand=2.9974*10^17;
...
factor=10;
nGuess = @(x) (1000000*x.^2+100*x+1)*factor;
nprime = @(x) (2000000*x+100)*factor;

pGuess = @(x) (-1000000*x.^2+100*x+1)*factor;
pprime = @(x) (-2000000*x+100)*factor;
...
fig6=figure;
plot(indexn,nGuess(node)-Cnjs)

fig6=figure;
plot(indexn,pGuess(node)-Cpjs)
