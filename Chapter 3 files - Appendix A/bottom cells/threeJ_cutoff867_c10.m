...
xout = xmax*decimation;  %Most recent value:1094
x_wave = xout+min1
yout = ymax*decimation;  %Most recent value:1562
y_wave = yout+min2
zout = zmax*decimation; %Most recent value:2416
z_wave = zout+min3

max_efficiency  %Most recent value:15.56%
