...
for index=wavelength_min/decimation:1:wavelength_max/decimation
    for index2 = index:1:wavelength_max/decimation
           efficiencies(index,index2) = solar_efficiency2(index*decimation,index2*decimation,ref3,max_power)/C;
    end
    index
end
...
xout = xmax*decimation %Most recent value:1236
yout = ymax*decimation %Most recent value:1792
max_efficiency %Most recent value:12.37%
