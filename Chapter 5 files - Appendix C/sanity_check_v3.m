...
pGuess = p1*exp(-gammap1*(x-1.5*10^-5))+p2*exp(-gammap2*(x-1.5*10^-5))+p3*exp(-gammap3*(x-1.5*10^-5));
...
fig1 = figure;
plot(y,subs(pGuess,x,y)), title('pGuess (symbolic)')
saveas(fig1,strcat('sanity check/',num2str(numIntervals),'terms/pGuess (symbolic).jpg'))

fig2 = figure;
plot(y,subs(nGuess,x,y)), title('nGuess (symbolic)')
saveas(fig2,strcat('sanity check/',num2str(numIntervals),'terms/nGuess (symbolic).jpg'))
...
%Handle 1st interval 'half case'
%Phis
matrixn(1,1) = quad(matlabFunction(phi_right(1)*(phi_right(1)+alphatestn*psi_right(1))), startPoint, intervalLength+startPoint)+alphatestn*quad(matlabFunction(psi_right(1)*(phi_right(1)+alphatestn*psi_right(1))),startPoint, intervalLength+startPoint);
...
matrixn(2*(numIntervals),2*(numIntervals+1)-2)= quad(matlabFunction(phi_left(numIntervals+1)*(phi_left(numIntervals+1)+betatestn*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint)+betatestn*quad(matlabFunction(psi_left(numIntervals+1)*(phi_left(numIntervals+1)+betatestn*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint);
...
saveas(fig3,strcat('sanity check/',num2str(numIntervals),'terms/pGuess_reomposition.jpg'))

fig4 = figure;
plot(indexn,Cnjs,indexn,subs(nGuess,x,indexn)),title('nGuess (recomposition)');
saveas(fig4,strcat('sanity check/',num2str(numIntervals),'terms/nGuess_reomposition.jpg'))

fig9 = figure;
plot(indexp,Dpjs,indexp,subs(diff(pGuess,x,1),x,indexp)),title('pprime (recomposition)');
saveas(fig9,strcat('sanity check/',num2str(numIntervals),'terms/pPrime_reomposition.jpg'))

fig10 = figure;
plot(indexn,Dnjs,indexn,subs(diff(nGuess,x,1),x,indexn)),title('nprime (recomposition)');
saveas(fig10,strcat('sanity check/',num2str(numIntervals),'terms/nPrime_reomposition.jpg'))
...
%alpha is boundary conditions term, p'(0)=alpha*p(0)
alphap = subs(diff(pGuess,x)/pGuess,x,0);
%beta is boundary condition term, p'(L) = beta p(L)
betap = subs(diff(pGuess,x)/pGuess,x,Wn);
...
% 
% %%nterm = ksi*T*mun/q*((p''(x)/p(x)-p'(x)/p(x))^2)-1/taun
...
% %Phis
% k=numIntervals+1;
% matrix3(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(matlabFunction((ksi*T*mun/q*(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,2)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left)-(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,1)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left))^2) - 1/taun)*phi_left(numIntervals+1)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+                                  betan*quad(matlabFunction((ksi*T*mun/q*(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,2)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left)-(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,1)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left))^2) - 1/taun)*psi_left(numIntervals+1)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% matrix3(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(matlabFunction((ksi*T*mun/q*(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,2)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left)-(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,1)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left))^2) - 1/taun)*phi_left(numIntervals+1)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+                                  betan*quad(matlabFunction((ksi*T*mun/q*(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,2)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left)-(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,1)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left))^2) - 1/taun)*psi_left(numIntervals+1)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% matrix3(2*(numIntervals),2*(numIntervals+1)-2)=   quad(matlabFunction((ksi*T*mun/q*(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,2)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left)-(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,1)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left))^2) - 1/taun)*phi_left(numIntervals+1)*(phi_left(numIntervals+1)+betan*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betan*quad(matlabFunction((ksi*T*mun/q*(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,2)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left)-(diff(px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left),x,1)/px(k,Cpjs,Dpjs,phi_right,phi_left,psi_right,psi_left))^2) - 1/taun)*psi_left(numIntervals+1)*(phi_left(numIntervals+1)+betan*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% 
% %Handle interval 2 and n-1 case
% %These intervals generate terms in the rows that would normally be in the
% %for-loop matrix, but are omitted due to boundary conditions.  Due to the
...
% %Handle 1st interval 'half case'
% %Phi test function
% rhs_matrix(1) = quad(matlabFunction(RHS*(phi_right(1)+alphap*psi_right(1))),startPoint,intervalLength+startPoint, Error);    
% 
% %Handle last interval 'half case'
% %Phi test function
% rhs_matrix(2*(numIntervals+1)-2) = quad(matlabFunction(RHS*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint,(numIntervals)*intervalLength+startPoint,Error);
%    
% RHSOutp =rhs_matrix;
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %Handle 1st interval 'half case'
% %Phis
% matrix1(1,1) = quad(matlabFunction(diff(phi_right(1),x,2)*(phi_right(1)+alphap*psi_right(1))), startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction(diff(psi_right(1),x,2)*(phi_right(1)+alphap*psi_right(1))),startPoint, intervalLength+startPoint,Error);
% matrix1(2,1) = quad(matlabFunction(diff(phi_right(1),x,2)*phi_left(2)),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction(diff(psi_right(1),x,2)*phi_left(2)),startPoint, intervalLength+startPoint,Error);
% matrix1(3,1) = quad(matlabFunction(diff(phi_right(1),x,2)*psi_left(2)),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction(diff(psi_right(1),x,2)*psi_left(2)),startPoint, intervalLength+startPoint,Error);
% 
% 
% %Handle last interval 'half case'
% %Phis
% matrix1(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(matlabFunction(diff(phi_left(numIntervals+1),x,2)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction(diff(psi_left(numIntervals+1),x,2)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% matrix1(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(matlabFunction(diff(phi_left(numIntervals+1),x,2)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction(diff(psi_left(numIntervals+1),x,2)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% matrix1(2*(numIntervals),2*(numIntervals+1)-2)= quad(matlabFunction(diff(phi_left(numIntervals+1),x,2)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction(diff(psi_left(numIntervals+1),x,2)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% 
% 
% %Handle interval 2 and n-1 case
% %These intervals generate terms in the rows that would normally be in the
...
% k=2;
% %Phi(k) Phi(k-1)
% matrix1(2*k-3,2*k-2) = quad(matlabFunction(diff(phi_left(k),x,2)*(phi_right(1)+alphap*psi_right(1))),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%  
% %Phi(k) Psi(k-1)
% %Omitted because of Psi(k-1) test function term, all subsequent terms are
% %shifted up one spot. 
...
% %Corresponds to column Dk
% %%Psi(k) Phi(k-1)
% matrix1(2*k-3,2*k-1) = quad(matlabFunction(diff(psi_left(k),x,2)*(phi_right(1)+alphap*psi_right(1))), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%   
% %Psi(k) Phi(k)
% matrix1(2*k-2,2*k-1) = quad(matlabFunction(diff(psi_left(k),x,2)*phi_left(k)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(matlabFunction(diff(psi_right(k),x,2)*phi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%    
...
%     
% %Phi(k) Phi(k+1)
% matrix1(2*k,2*k-2) = quad(matlabFunction(diff(phi_right(k),x,2)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
% %%Calculate for interval's Psi basis function
% %Corresponds to column Dk
% %%Psi(k) Phi(k-1)
...
%     
% %Psi(k) Phi(k+1)
% matrix1(2*k,2*k-1) = quad(matlabFunction(diff(psi_right(k),x,2)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
% 
...
for k = 3:numIntervals-1
    ...
    %Phi(k) Phi(k-1)    
    matrix2(2*k-4,2*k-2) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(k),x,1)*phi_right(k-1)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);

    %Phi(k) Psi(k-1)
    matrix2(2*k-3,2*k-2) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(k),x,1)*psi_right(k-1)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
   
    %Phi(k) Phi(k)
    matrix2(2*k-2,2*k-2) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(k),x,1)*phi_left(k)),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(k),x,1)*phi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k)
    matrix2(2*k-1,2*k-2) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(k),x,1)*psi_left(k)),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(k),x,1)*psi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Phi(k+1)
    matrix2(2*k,2*k-2) = quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(k),x,1)*phi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Phi(k) Psi(k+1)
    matrix2(2*k+1,2*k-2) = quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(k),x,1)*psi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);   
     

    %%Calculate for interval's Psi basis function
    %Corresponds to column Dk
    %%Psi(k) Phi(k-1)
    matrix2(2*k-4,2*k-1) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(k),x,1)*phi_right(k-1)), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);

    %Psi(k) Psi(k-1)
    matrix2(2*k-3,2*k-1) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(k),x,1)*psi_right(k-1)), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
   
    %Psi(k) Phi(k)
    matrix2(2*k-2,2*k-1) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(k),x,1)*phi_left(k)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(k),x,1)*phi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k)
    matrix2(2*k-1,2*k-1) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(k),x,1)*psi_left(k)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(k),x,1)*psi_right(k)),(k-1)*intervalLength+startPoint,(k)*intervalLength+startPoint,Error);
    
    %Psi(k) Phi(k+1)
    matrix2(2*k,2*k-1) = quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(k),x,1)*phi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
    %Psi(k) Psi(k+1)
    matrix2(2*k+1,2*k-1) = quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(k),x,1)*psi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
    
end

%Handle 1st interval 'half case'
%Phis
matrix2(1,1) = quad(matlabFunction(diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(1),x,1)*(phi_right(1)+alphap*psi_right(1))),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction(diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(1),x,1)*(phi_right(1)+alphap*psi_right(1))),startPoint, intervalLength+startPoint,Error);
matrix2(2,1) = quad(matlabFunction(diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(1),x,1)*phi_left(2)),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction(diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(1),x,1)*phi_left(2)),startPoint, intervalLength+startPoint,Error);
matrix2(3,1) = quad(matlabFunction(diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(1),x,1)*psi_left(2)),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction(diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(1),x,1)*psi_left(2)),startPoint, intervalLength+startPoint,Error);


%Handle last interval 'half case'
%Phis
matrix2(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(matlabFunction(diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(numIntervals+1),x,1)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction(diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(numIntervals+1),x,1)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix2(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(matlabFunction(diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(numIntervals+1),x,1)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction(diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(numIntervals+1),x,1)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
matrix2(2*(numIntervals),2*(numIntervals+1)-2)= quad(matlabFunction(diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(numIntervals+1),x,1)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction(diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(numIntervals+1),x,1)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
...
k=2;
%Phi(k) Phi(k-1)
matrix2(2*k-3,2*k-2) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_left(k),x,1)*(phi_right(1)+alphap*psi_right(1))),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
...
%Corresponds to column Dk
%%Psi(k) Phi(k-1)
matrix2(2*k-3,2*k-1) = quad(matlabFunction(diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_left(k),x,1)*(phi_right(1)+alphap*psi_right(1))), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
...
%Phi(k) Phi(k+1)
matrix2(2*k,2*k-2) = quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(phi_right(k),x,1)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
...
%Psi(k) Phi(k+1)
matrix2(2*k,2*k-1) = quad(matlabFunction(diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)*diff(psi_right(k),x,1)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
...
% %%term associated with phi_left(k) interval of p(x)
% %%(ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)
% %%term associated with phi_right(k) interval of p(x)
% %%(ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)
% 
% for k = 3:numIntervals-1
%    
%     %%Calculate for interval's Phi basis function
%     %%Corresponds to column Ck
%     %Phi(k) Phi(k-1)
%     matrix3(2*k-4,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(k)*phi_right(k-1)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
% 
%     %Phi(k) Psi(k-1)
%     matrix3(2*k-3,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(k)*psi_right(k-1)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%    
%     %Phi(k) Phi(k)
%     matrix3(2*k-2,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(k)*phi_left(k)),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(k)*phi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Phi(k) Psi(k)
%     matrix3(2*k-1,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(k)*psi_left(k)),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(k)*psi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Phi(k) Phi(k+1)
%     matrix3(2*k,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(k)*phi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Phi(k) Psi(k+1)
%     matrix3(2*k+1,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(k)*psi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);   
%      
% 
%     %%Calculate for interval's Psi basis function
%     %Corresponds to column Dk
%     %%Psi(k) Phi(k-1)
%     matrix3(2*k-4,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(k)*phi_right(k-1)), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
% 
%     %Psi(k) Psi(k-1)
%     matrix3(2*k-3,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(k)*psi_right(k-1)), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%    
%     %Psi(k) Phi(k)
%     matrix3(2*k-2,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(k)*phi_left(k)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(k)*phi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Psi(k) Psi(k)
%     matrix3(2*k-1,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(k)*psi_left(k)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(k)*psi_right(k)),(k-1)*intervalLength+startPoint,(k)*intervalLength+startPoint,Error);
%     
%     %Psi(k) Phi(k+1)
%     matrix3(2*k,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(k)*phi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
%     %Psi(k) Psi(k+1)
%     matrix3(2*k+1,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(k)*psi_left(k+1)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
% end
% 
% %Handle 1st interval 'half case'
% %Phis
% 
% matrix3(1,1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(1)*(phi_right(1)+alphap*psi_right(1))),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction((ksi*T*mup/q*((diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(1)*(phi_right(1)+alphap*psi_right(1))),startPoint, intervalLength+startPoint,Error);
% matrix3(2,1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(1)*phi_left(2)),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction((ksi*T*mup/q*((diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(1)*phi_left(2)),startPoint, intervalLength+startPoint,Error);
% matrix3(3,1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(1)*psi_left(2)),startPoint, intervalLength+startPoint,Error)+alphap*quad(matlabFunction((ksi*T*mup/q*((diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(2,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(1)*psi_left(2)),startPoint, intervalLength+startPoint,Error);
% 
% %Handle last interval 'half case'
% %Phis
% 
% matrix3(2*(numIntervals)-2,2*(numIntervals+1)-2)= quad(matlabFunction((ksi*T*mup/q*((diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(numIntervals+1)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction((ksi*T*mup/q*((diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(numIntervals+1)*phi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% matrix3(2*(numIntervals)-1,2*(numIntervals+1)-2)= quad(matlabFunction((ksi*T*mup/q*((diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(numIntervals+1)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction((ksi*T*mup/q*((diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(numIntervals+1)*psi_right(numIntervals)),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% matrix3(2*(numIntervals),2*(numIntervals+1)-2)=   quad(matlabFunction((ksi*T*mup/q*((diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(numIntervals+1)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error)+betap*quad(matlabFunction((ksi*T*mup/q*((diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(numIntervals+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(numIntervals+1)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(numIntervals-1)*intervalLength+startPoint, (numIntervals)*intervalLength+startPoint,Error);
% 
% %Handle interval 2 and n-1 case
% %These intervals generate terms in the rows that would normally be in the
% %for-loop matrix, but are omitted due to boundary conditions.  Due to the
...
% k=2;
% %Phi(k) Phi(k-1)
% matrix3(2*k-3,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(k)*(phi_right(1)+alphap*psi_right(1))),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
% 
% %Phi(k) Phi(k)
% matrix3(2*k-2,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_left(k)*phi_left(k)),(k-2)*intervalLength+startPoint,(k-1)*intervalLength+startPoint,Error)+quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(k)*phi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
...
% %Corresponds to column Dk
% %%Psi(k) Phi(k-1)
% matrix3(2*k-3,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(k)*(phi_right(1)+alphap*psi_right(1))), (k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error);
%   
% %Psi(k) Phi(k)
% matrix3(2*k-2,2*k-1) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_left(k)*phi_left(k)),(k-2)*intervalLength+startPoint, (k-1)*intervalLength+startPoint,Error)+quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*psi_right(k)*phi_right(k)),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%    
...
%     
% %Phi(k) Phi(k+1)
% matrix3(2*k,2*k-2) = quad(matlabFunction((ksi*T*mup/q*((diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,1)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left))^2 - diff(nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left),x,2)/nx(k+1,Cnjs,Dnjs,phi_right,phi_left,psi_right,psi_left)) - 1/taup)*phi_right(k)*(phi_left(numIntervals+1)+betap*psi_left(numIntervals+1))),(k-1)*intervalLength+startPoint, (k)*intervalLength+startPoint,Error);
%     
% 
% %%Calculate for interval's Psi basis function
% %Corresponds to column Dk
...
saveas(fig5,strcat('sanity check/',num2str(numIntervals),'terms/nGuess_output.jpg'))

fig6 = figure;
plot(indexn,Cpjs,indexp,subs(pGuess,x,indexp));title('p(x) calculated');
saveas(fig6,strcat('sanity check/',num2str(numIntervals),'terms/pGuess_output.jpg'))


fig7 = figure;%indexn,subs(diff(nGuess,x,1),x,indexn)
plot(indexn,Dnjs),title('nprime calculated');
saveas(fig7,strcat('sanity check/',num2str(numIntervals),'terms/nPrime_output.jpg'))

fig8 = figure;
plot(indexp,Dpjs),title('pprime calculated');
saveas(fig8,strcat('sanity check/',num2str(numIntervals),'terms/pPrime_output.jpg'))
