...
xout = xmax*decimation;  %Most recent value:625
x_wave = xout+min1
yout = ymax*decimation;  %Most recent value:845
y_wave = yout+min2
zout = zmax*decimation; %Most recent value:1170
z_wave = zout+min3
wout = wmax*decimation; %Most recent value:1750
w_wave = wout+min4

max_efficiency  %Most recent value:57.68%
