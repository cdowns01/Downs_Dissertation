...
File {
	Grid = "n610_msh.tdr"
	Plot    = "n643_des.tdr"	*Commented out to limit memory usage on system.  Add back in for individual experiments, not long optimization simulations.
 	Current = "n643_des.plt"
	Output  = "n643_des.log"
	Parameter = "pp643_des.par"
	IlluminationSpectrum = "n639_am15d.txt"
      }
...
Solve   {
	 ...
	 * Plot (FilePrefix = "n643_sc")
    	
    	*CurrentPlot()
     	*System("rm -f n643_banddgm_des.tdr")
     	
     	Quasistationary ( 
   		 InitialStep=5e-2 MaxStep =1e-2 MinStep = 1e-3 
    		Goal{ voltage = 2 Name = "front" }
 	   ){ Coupled {Poisson Electron Hole  } } 
    
    
    	Plot (FilePrefix = "n643_debug")
    	
  	 Quasistationary ( 
   		 InitialStep=5e-10 MaxStep =1e-3 MinStep = 1e-20 
