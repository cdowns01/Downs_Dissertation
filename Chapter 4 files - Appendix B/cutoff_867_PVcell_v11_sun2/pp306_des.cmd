...
File {
	Grid = "n291_msh.tdr"
	Plot    = "n306_des.tdr"	*Commented out to limit memory usage on system.  Add back in for individual experiments, not long optimization simulations.
 	Current = "n306_des.plt"
	Output  = "n306_des.log"
	Parameter = "pp306_des.par"
	IlluminationSpectrum = "n302_am15d.txt"
      }
...
Solve   {
 Coupled (Iterations=20) {Poisson}
	 ...
	 * Plot (FilePrefix = "n306_sc")
    	
    	*CurrentPlot()
     	*System("rm -f n306_banddgm_des.tdr")
