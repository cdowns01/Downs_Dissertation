...
filepath=strcat('stability test v10/rand',num2str(randLow),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
for k = 1:numIntervals-2
	%%phi_righ*phi_right
	matrix2(2*k,2*k) = matrix2(2*k,2*k) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f1((x-node(k+1))).*f1prime((x-node(k+1))),node(k+1),node(k+2),Error);
    
	%% phi_right*phi_left
	matrix2(2*k,2*(k+1)) = matrix2(2*k,2*(k+1)) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f1((x-node(k+1))).*f2prime((x-node(k+1))),node(k+1),node(k+2),Error);

       
	%% phi_left*phi_right
	matrix2(2*(k+1),2*(k)) = matrix2(2*(k+1),2*(k)) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f2((x-node(k+1))).*f1prime((x-node(k+1))),node(k+1),node(k+2),Error);

	%% phi_left*phi_left
	matrix2(2*(k+1),2*(k+1)) = matrix2(2*(k+1),2*(k+1)) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f2((x-node(k+1))).*f2prime((x-node(k+1))),node(k+1),node(k+2),Error); 

    
    
	%% phi_right*psi_right
	matrix2(2*k,2*k+1) = matrix2(2*k,2*k+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f1((x-node(k+1))).*f3prime((x-node(k+1))),node(k+1),node(k+2),Error);%

	%% phi_right*psi_left
	matrix2(2*k,2*(k+1)+1) = matrix2(2*k,2*(k+1)+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f1((x-node(k+1))).*f4prime((x-node(k+1))),node(k+1),node(k+2),Error);

    
    
	%% phi_left*psi_right
	matrix2(2*(k+1),2*k+1) = matrix2(2*(k+1),2*k+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f2((x-node(k+1))).*f3prime((x-node(k+1))),node(k+1),node(k+2),Error);

	%% phi_left*psi_left
	matrix2(2*(k+1),2*(k+1)+1) = matrix2(2*(k+1),2*(k+1)+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f2((x-node(k+1))).*f4prime((x-node(k+1))),node(k+1),node(k+2),Error);%

    
    
    %psi_right*phi_right
    matrix2(2*k+1,2*k) = matrix2(2*k+1,2*k) + quad(@(x)  pprime_dist{k+1}(x)./p_dist{k+1}(x).*f3((x-node(k+1))).*f1prime((x-node(k+1))),node(k+1),node(k+2),Error);%
    
    %psi_right*phi_left
    matrix2(2*k+1,2*(k+1))=matrix2(2*k+1,2*(k+1)) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f3((x-node(k+1))).*f2prime((x-node(k+1))),node(k+1),node(k+2),Error);
    
    
    
    %psi_left*phi_right
    matrix2(2*(k+1)+1,2*k)=matrix2(2*(k+1)+1,2*k) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f4((x-node(k+1))).*f1prime((x-node(k+1))),node(k+1),node(k+2),Error);
    
    %psi_left*psi_left
    matrix2(2*(k+1)+1,2*(k+1))=matrix2(2*(k+1)+1,2*(k+1)) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f4((x-node(k+1))).*f2prime((x-node(k+1))),node(k+1),node(k+2),Error);  %
    
    
    
	%% psi_right*psi_right
	matrix2(2*k+1,2*k+1) = matrix2(2*k+1,2*k+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f3((x-node(k+1))).*f3prime((x-node(k+1))),node(k+1),node(k+2),Error);

	%% psi_right*psi_left
	matrix2(2*k+1,2*(k+1)+1) = matrix2(2*k+1,2*(k+1)+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f3((x-node(k+1))).*f4prime((x-node(k+1))),node(k+1),node(k+2),Error);

    
    
	%% psi_left*psi_right
	matrix2(2*(k+1)+1,2*k+1) = matrix2(2*(k+1)+1,2*k+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f4((x-node(k+1))).*f3prime((x-node(k+1))),node(k+1),node(k+2),Error);

	%% psi_left*psi_right
	matrix2(2*(k+1)+1,2*(k+1)+1) = matrix2(2*(k+1)+1,2*(k+1)+1) + quad(@(x) pprime_dist{k+1}(x)./p_dist{k+1}(x).*f4((x-node(k+1))).*f4prime((x-node(k+1))),node(k+1),node(k+2),Error);
end

%Handle 1st interval 'half case'
matrix2(1,1) = quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*(f1prime((x-node(1))) + alphan*f3prime((x-node(1)))),node(1),node(1)+dx,Error);
matrix2(1,2) = quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*f2prime((x-node(1))),node(1),node(1)+dx,Error);
matrix2(1,3) = quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*f4prime((x-node(1))),node(1),node(1)+dx,Error);
matrix2(2,1) = quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*(f1prime((x-node(1))) + alphan*f3prime((x-node(1)))).*f2((x-node(1))),node(1),node(1)+dx,Error);
matrix2(3,1) = quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*(f1prime((x-node(1))) + alphan*f3prime((x-node(1)))).*f4((x-node(1))),node(1),node(1)+dx,Error);

matrix2(2,2) = matrix2(2,2) + quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*f2(x).*f2prime(x),node(1),node(1)+dx,Error);
matrix2(2,3) = matrix2(2,3) + quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*f2(x).*f4prime(x),node(1),node(1)+dx,Error);
matrix2(3,2) = matrix2(3,2) + quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*f2prime(x).*f4(x),node(1),node(1)+dx,Error);
matrix2(3,3) = matrix2(3,3) + quad(@(x) pprime_dist{1}(x)./p_dist{1}(x).*f4(x).*f4prime(x),node(1),node(1)+dx,Error);

%Handle last interval 'half case'
matrix2(last,last) =   quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*(f2prime((x-node(end)+dx)) + betan*f4prime((x-node(end)+dx))),node(end)-dx,node(end),Error);
matrix2(last,last-2) = quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*f1prime((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix2(last,last-1) = quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*f3prime((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix2(last-2,last) = quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*(f2prime((x-node(end)+dx)) + betan*f4prime((x-node(end)+dx))).*f1((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix2(last-1,last) = quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*(f2prime((x-node(end)+dx)) + betan*f4prime((x-node(end)+dx))).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);

matrix2(last-2,last-2) = matrix2(last-2,last-2) + quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*f1prime((x-node(end)+dx)).*f1((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix2(last-2,last-1) = matrix2(last-2,last-1) + quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*f1((x-node(end)+dx)).*f3prime((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix2(last-1,last-2) = matrix2(last-1,last-2) + quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).*f1prime((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix2(last-1,last-1) = matrix2(last-1,last-1) + quad(@(x) pprime_dist{end-1}(x)./p_dist{end-1}(x).* f3prime((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);   
...
for k = 1:numIntervals-2
	%%phi_righ*phi_right
	matrix3(2*k,2*k) = matrix3(2*k,2*k) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f1((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),Error);
    
	%% phi_right*phi_left
	matrix3(2*k,2*(k+1)) = matrix3(2*k,2*(k+1)) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f1((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),Error);

       
	%% phi_left*phi_right
	matrix3(2*(k+1),2*(k)) = matrix3(2*(k+1),2*(k)) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f2((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),Error);

	%% phi_left*phi_left
	matrix3(2*(k+1),2*(k+1)) = matrix3(2*(k+1),2*(k+1)) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f2((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),Error); 

    
    
	%% phi_right*psi_right
	matrix3(2*k,2*k+1) = matrix3(2*k,2*k+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f1((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),Error);%

	%% phi_right*psi_left
	matrix3(2*k,2*(k+1)+1) = matrix3(2*k,2*(k+1)+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f1((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),Error);

    
    
	%% phi_left*psi_right
	matrix3(2*(k+1),2*k+1) = matrix3(2*(k+1),2*k+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f2((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),Error);

	%% phi_left*psi_left
	matrix3(2*(k+1),2*(k+1)+1) = matrix3(2*(k+1),2*(k+1)+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f2((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),Error);%

    
    
    %psi_right*phi_right
    matrix3(2*k+1,2*k) = matrix3(2*k+1,2*k) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f3((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),Error);%
    
    %psi_right*phi_left
    matrix3(2*k+1,2*(k+1))=matrix3(2*k+1,2*(k+1)) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f3((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),Error);
    
    
    
    %psi_left*phi_right
    matrix3(2*(k+1)+1,2*k)=matrix3(2*(k+1)+1,2*k) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f4((x-node(k+1))).*f1((x-node(k+1))),node(k+1),node(k+2),Error);
    
    %psi_left*psi_left
    matrix3(2*(k+1)+1,2*(k+1))=matrix3(2*(k+1)+1,2*(k+1)) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f4((x-node(k+1))).*f2((x-node(k+1))),node(k+1),node(k+2),Error);  %
    
    
    
	%% psi_right*psi_right
	matrix3(2*k+1,2*k+1) = matrix3(2*k+1,2*k+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f3((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),Error);

	%% psi_right*psi_left
	matrix3(2*k+1,2*(k+1)+1) = matrix3(2*k+1,2*(k+1)+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f3((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),Error);

    
    
	%% psi_left*psi_right
	matrix3(2*(k+1)+1,2*k+1) = matrix3(2*(k+1)+1,2*k+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f4((x-node(k+1))).*f3((x-node(k+1))),node(k+1),node(k+2),Error);

	%% psi_left*psi_right
	matrix3(2*(k+1)+1,2*(k+1)+1) = matrix3(2*(k+1)+1,2*(k+1)+1) + quad(@(x) (ksi.*T.*mun./q.*(pdouble_dist{k+1}(x)./p_dist{k+1}(x)-(pprime_dist{k+1}(x)./p_dist{k+1}(x)).^2)-1/taun).*f4((x-node(k+1))).*f4((x-node(k+1))),node(k+1),node(k+2),Error);
end


%Handle 1st interval 'half case'
matrix3(1,1) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*(f1((x-node(1))) + alphan*f3((x-node(1)))),node(1),node(1)+dx,Error);
matrix3(1,2) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*f2((x-node(1))),node(1),node(1)+dx,Error);
matrix3(1,3) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*f4((x-node(1))),node(1),node(1)+dx,Error);
matrix3(2,1) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*f2((x-node(1))),node(1),node(1)+dx,Error);
matrix3(3,1) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*(f1((x-node(1))) + alphan*f3((x-node(1)))).*f4((x-node(1))),node(1),node(1)+dx,Error);

 matrix3(2,2) = matrix3(2,2) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*f2(x).*f2(x),node(1),node(1)+dx,Error);
 matrix3(2,3) = matrix3(2,3) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*f2(x).*f4(x),node(1),node(1)+dx,Error);
 matrix3(3,2) = matrix3(3,2) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*f2(x).*f4(x),node(1),node(1)+dx,Error);
 matrix3(3,3) = matrix3(3,3) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{1}(x)./p_dist{1}(x)-(pprime_dist{1}(x)./p_dist{1}(x)).^2)-1/taun).*f4(x).*f4(x),node(1),node(1)+dx,Error);

%Handle last interval 'half case'
matrix3(last,last) =   quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))),node(end)-dx,node(end),Error);
matrix3(last,last-2) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*f1((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix3(last,last-1) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix3(last-2,last) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*f1((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix3(last-1,last) = quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*(f2((x-node(end)+dx)) + betan*f4((x-node(end)+dx))).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);

matrix3(last-2,last-2) = matrix3(last-2,last-2) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*f1((x-node(end)+dx)).*f1((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix3(last-2,last-1) = matrix3(last-2,last-1) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*f1((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix3(last-1,last-2) = matrix3(last-1,last-2) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*f1((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);
matrix3(last-1,last-1) = matrix3(last-1,last-1) + quad(@(x)  (ksi.*T.*mun./q.*(pdouble_dist{end-1}(x)./p_dist{end-1}(x)-(pprime_dist{end-1}(x)./p_dist{end-1}(x)).^2)-1/taun).*f3((x-node(end)+dx)).*f3((x-node(end)+dx)),node(end)-dx,node(end),Error);   
...
figure
peclet = Cn2/Cn1*Dpjs./Cpjs*intervalLength;
plot(peclet)
%Solve simultaneous equations for basis function coefficients
