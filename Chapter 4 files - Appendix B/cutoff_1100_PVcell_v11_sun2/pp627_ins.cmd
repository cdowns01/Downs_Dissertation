...
proj_load  n625_des.plt PLT_JV($N)
...
gr_setAxisAttr X {Voltage (V)}  20 0 3.5 black 1 20 0 5 0
gr_setAxisAttr Y {Current Density (mA/cm^2)} 19 0 {} black 1 20 0 5 0
...
set Ps 1000 ;#Incident light power density for AM1.5d radiation in mW/cm^2
if {$Voc($N) > 0} {
