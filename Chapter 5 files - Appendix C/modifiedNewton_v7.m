...
%1st two terms full, 1/tau of last terms
...
filepath=strcat('modifiedNewton v7/rand',num2str(rand),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
n1rand=-3.63681*10^10;
n2rand=7.48779*10^11;
n3rand=-2.11622*10^14;
n4rand=2.22022*10^14;
...
p1rand=-3.82636*10^16;
p2rand=-4.61456*10^11;
p3rand=-3.87746*10^17;
p4rand=4.26024*10^17;
...
[x,fval,exitflag,output,Jacobian]= fsolve(@(x)callFunction7(x),Coeffs,options);
