...
mkdir(strcat(filepath,'/Individual Matrix'));
syms x
...
fig3 = figure;
plot(y,subs(pGuess_syms,x,y)), title('pGuess (noise)')
...
alpha = subs(diff(pGuess_syms,x),x,0)/subs(pGuess_syms,x,0);

%beta is boundary condition term, n'(L) = beta n(L)
beta= subs(diff(pGuess_syms,x),x,Wn)/subs(pGuess_syms,x,Wn);
...
%p''(x)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Coeffsp1 = Matrix1Finalp\RHSOutp;

for index=2:length(Cpjs)-1
   Cpjs(1,index) = Coeffsp1(2*index-2);
   Dpjs(1,index) = Coeffsp1(2*index-1);
end

Cpjs(1,1) = Coeffsp1(1);
Dpjs(1,1) = alphap*Coeffsp1(1);

Cpjs(1,numIntervals+1) = Coeffsp1(length(Coeffsp1));
Dpjs(1,numIntervals+1) = betap*Coeffsp1(length(Coeffsp1));

fig5 = figure;
plot(indexp,Cpjs,indexp,subs(pGuess,x,indexp));title('p1 Cjs');
saveas(fig5,strcat(filepath,'/Individual Matrix/p1 Cjs iteration',num2str(iterationCount),'.jpg'))


fig7 = figure;
plot(indexp,Dpjs,indexp,subs(diff(pGuess,x,1),x,indexp)),title('p1 Djs');
saveas(fig7,strcat(filepath,'/Individual Matrix/p1 Djs iteration',num2str(iterationCount),'.jpg'))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%p'(x)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Coeffsp2 = Matrix2Finalp\RHSOutp;

for index=2:length(Cpjs)-1
   Cpjs(1,index) = Coeffsp2(2*index-2);
   Dpjs(1,index) = Coeffsp2(2*index-1);
end

Cpjs(1,1) = Coeffsp2(1);
Dpjs(1,1) = alphap*Coeffsp2(1);

Cpjs(1,numIntervals+1) = Coeffsp2(length(Coeffsp2));
Dpjs(1,numIntervals+1) = betap*Coeffsp2(length(Coeffsp2));

fig5 = figure;
plot(indexp,Cpjs,indexp,subs(pGuess,x,indexp));title('p2 Cjs');
saveas(fig5,strcat(filepath,'/Individual Matrix/p2 Cjs iteration',num2str(iterationCount),'.jpg'))


fig7 = figure;
plot(indexp,Dpjs,indexp,subs(diff(pGuess,x,1),x,indexp)),title('p2 Djs');
saveas(fig7,strcat(filepath,'/Individual Matrix/p2 Djs iteration',num2str(iterationCount),'.jpg'))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%p(x)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Coeffsp3 = Matrix3Finalp\RHSOutp;

for index=2:length(Cpjs)-1
   Cpjs(1,index) = Coeffsp3(2*index-2);
   Dpjs(1,index) = Coeffsp3(2*index-1);
end

Cpjs(1,1) = Coeffsp3(1);
Dpjs(1,1) = alphap*Coeffsp3(1);

Cpjs(1,numIntervals+1) = Coeffsp3(length(Coeffsp3));
Dpjs(1,numIntervals+1) = betap*Coeffsp3(length(Coeffsp3));

fig5 = figure;
plot(indexp,Cpjs,indexp,subs(pGuess,x,indexp));title('p3 Cjs');
saveas(fig5,strcat(filepath,'/Individual Matrix/p3 Cjs iteration',num2str(iterationCount),'.jpg'))


fig7 = figure;
plot(indexp,Dpjs,indexp,subs(diff(pGuess,x,1),x,indexp)),title('p3 Djs');
saveas(fig7,strcat(filepath,'/Individual Matrix/p3 Djs iteration',num2str(iterationCount),'.jpg'))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%n''(x)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Coeffsn1 = Matrix1Finaln\RHSOutn;

for index=2:length(Cpjs)-1
   Cnjs(1,index) = Coeffsn1(2*index-2);
   Dnjs(1,index) = Coeffsn1(2*index-1);
end

Cnjs(1,1) = Coeffsn1(1);
Dnjs(1,1) = alphan*Coeffsn1(1);

Cnjs(1,numIntervals+1) = Coeffsn1(length(Coeffsn1));
Dnjs(1,numIntervals+1) = betan*Coeffsn1(length(Coeffsn1));

fig5 = figure;
plot(indexn,Cnjs,indexn,subs(nGuess,x,indexn));title('n1 Cjs');
saveas(fig5,strcat(filepath,'/Individual Matrix/n1 Cjs iteration',num2str(iterationCount),'.jpg'))


fig7 = figure;
plot(indexn,Dnjs,indexn,subs(diff(nGuess,x,1),x,indexn)),title('n1 Djs');
saveas(fig7,strcat(filepath,'/Individual Matrix/n1 Djs iteration',num2str(iterationCount),'.jpg'))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%n'(x)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Coeffsn2 = Matrix2Finaln\RHSOutn;

for index=2:length(Cnjs)-1
   Cnjs(1,index) = Coeffsn2(2*index-2);
   Dnjs(1,index) = Coeffsn2(2*index-1);
end

Cnjs(1,1) = Coeffsn2(1);
Dnjs(1,1) = alphan*Coeffsn2(1);

Cnjs(1,numIntervals+1) = Coeffsn2(length(Coeffsn2));
Dnjs(1,numIntervals+1) = betan*Coeffsn2(length(Coeffsn2));

fig5 = figure;
plot(indexn,Cnjs,indexn,subs(nGuess,x,indexn));title('n2 Cjs');
saveas(fig5,strcat(filepath,'/Individual Matrix/n2 Cjs iteration',num2str(iterationCount),'.jpg'))


fig7 = figure;
plot(indexp,Dnjs,indexn,subs(diff(nGuess,x,1),x,indexn)),title('n2 Djs');
saveas(fig7,strcat(filepath,'/Individual Matrix/n2 Djs iteration',num2str(iterationCount),'.jpg'))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%n(x)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Coeffsn3 = Matrix3Finaln\RHSOutn;

for index=2:length(Cpjs)-1
   Cnjs(1,index) = Coeffsn3(2*index-2);
   Dnjs(1,index) = Coeffsn3(2*index-1);
end

Cnjs(1,1) = Coeffsn3(1);
Dnjs(1,1) = alphan*Coeffsn3(1);

Cnjs(1,numIntervals+1) = Coeffsn3(length(Coeffsn3));
Dnjs(1,numIntervals+1) = betan*Coeffsn3(length(Coeffsn3));

fig5 = figure;
plot(indexn,Cnjs,indexp,subs(nGuess,x,indexn));title('n3 Cjs');
saveas(fig5,strcat(filepath,'/Individual Matrix/n3 Cjs iteration',num2str(iterationCount),'.jpg'))


fig7 = figure;
plot(indexn,Dnjs,indexn,subs(diff(nGuess,x,1),x,indexn)),title('n3 Djs');
saveas(fig7,strcat(filepath,'/Individual Matrix/n3 Djs iteration',num2str(iterationCount),'.jpg'))
