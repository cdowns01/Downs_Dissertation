...
proj_load  n76_des.plt PLT_JV($N)
...
gr_setAxisAttr X {Voltage (V)}  28 {} {} black 1 25 0 5 0
gr_setAxisAttr Y {Current Density (mA/cm^2)} 28 0 30 black 1 25 0 5 0
...
set Ps 100 ;#Incident light power density for AM1.5d radiation in mW/cm^2
if {$Voc($N) > 0} {
