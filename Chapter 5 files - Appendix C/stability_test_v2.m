...
filepath=strcat('stability test/rand',num2str(randLow),'/',num2str(numIntervals),'terms');
mkdir(filepath)
...
fig3 = figure;
plot(y,subs(pGuess,x,y)), title('pGuess (noise)')
...
saveas(fig4,strcat(filepath,'/pprime_reomposition.jpg'))
...
saveas(fig5,strcat(filepath,'/p_calculated_iteration',num2str(iterationCount),'.jpg'))
...
saveas(fig7,strcat(filepath,'/pprime_calculated_iteration',num2str(iterationCount),'.jpg'))
