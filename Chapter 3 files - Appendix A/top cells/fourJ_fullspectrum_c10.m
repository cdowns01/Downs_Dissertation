...
xout = xmax*decimation;  %Most recent value:620
x_wave = xout+min1
yout = ymax*decimation;  %Most recent value:835
y_wave = yout+min2
zout = zmax*decimation; %Most recent value:1125
z_wave = zout+min3
wout = wmax*decimation; %Most recent value:1695
w_wave = wout+min4

max_efficiency  %Most recent value:54.28%
