...
File {
	Grid = "n91_msh.tdr"
	Plot    = "n394_des.tdr"	*Commented out to limit memory usage on system.  Add back in for individual experiments, not long optimization simulations.
 	Current = "n394_des.plt"
	Output  = "n394_des.log"
	Parameter = "pp394_des.par"
	IlluminationSpectrum = "n138_am15d.txt"
      }
...
Solve   {
	 ...
	 * Plot (FilePrefix = "n394_sc")
    	
    	*CurrentPlot()
     	*System("rm -f n394_banddgm_des.tdr")
     	
     	Quasistationary ( 
   		 InitialStep=5e-2 MaxStep =1e-2 MinStep = 1e-3 
    		Goal{ voltage = .9 Name = "front" }
 	   ){ Coupled {Poisson Electron Hole  } } 
